...
def apply_full_patch(
    ...
    try:
        ...
        def _normalize_payload_for_range(payload: str) -> str:
            """Normalize only boundary newlines before inserting a mutable payload."""
        ...
        if patch_has_both:
            ...
            if len(mutable_ranges) == 1:
                ...
                if patch_code.startswith(prefix_outside) and any(
                    ...
                    replacement_content = _normalize_payload_for_range(replacement_content)
                    updated_content = (
                    ...
                    payload = _normalize_payload_for_range(patch_code)
            ...
            payload = _normalize_payload_for_range(payload)
